...
export DOCKER_COMPOSE_FILE_NAME=" -f ${DOCKER_COMPOSE_DIR}/rental-dc.yml"
...
case ${arg} in 
   ...
   "restart")
        ...
        echo ''
        echo '#############################################'
        echo '###      RENTAL RESTART containers        ###'
        echo '#############################################'
        echo ''
        echo 'Stopping ...'
        docker-compose $DOCKER_ENV_FILE --profile dev $DOCKER_COMPOSE_FILE_NAME stop
