package org.solar.system.hexa.infra.translator;
...
public class LocaleResolver extends AcceptHeaderLocaleResolver {
    ...
    private final List<String> languageSupported = AuthLanguageSupported.listFromEnum();
    ...
    public Locale resolveLocale(HttpServletRequest request) {
        ...
        List<LanguageRange> parsedLocale = LanguageRange.parse(headerLang);
